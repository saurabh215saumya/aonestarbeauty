...
<div class="content-wrapper">
	...
	<div class="row">
		...
		<div class="box">
		    ...
		    <div class="box-body">
			<!-- form start -->
			<?php echo form_open_multipart($controller.'/add_newpackage'); ?>
			<div class="box-body">
			    ...
			    <div class="form-group">
					...
					<input class="form-control" id="package_name" name="package_name" placeholder="Menu Name" type="text" value="<?php echo set_value('package_name') ?>">
			    ...
			    <div class="form-group">
					...
					<?php echo BASE_URL; ?> <input class="form-control" id="package_slug" name="package_slug" placeholder="Page Slug" type="text" value="<?php echo set_value('package_slug') ?>" required>
