...
<div class="content-wrapper">
	...
	<ol class="breadcrumb">
	    ...
	    <li class="active"><a href="<?php echo base_url($controller); ?>">Menu</a></li>
	...
	<div class="row">
		...
		<div class="box">
		    ...
		    <div class="box-body">
			<!-- form start -->
			<?php echo form_open_multipart($controller.'/update_package'); ?>
			<div class="box-body">
			    <?php echo $this->session->flashdata('response'); ?>
			    <input type="hidden" name="package_id" value="<?php echo $details['id']; ?>">
			    ...
			    <div class="form-group">
				<label for="name">Menu Name<span style="color: #ff0000">*</span></label>
				<input class="form-control" name="package_name" id="package_name" placeholder="Menu Name" type="text" value="<?php echo $details['package_name']; ?>" required>
			    ...
			    <div class="form-group">
					...
					<?php echo BASE_URL; ?> <input class="form-control" name="package_slug" id="package_slug" placeholder="Page Slug<?php echo BASE_URL; ?> " type="text" value="<?php echo $details['package_slug']; ?>" readonly>
					<?php echo form_error('package_slug'); ?>				
			    </div>
				  ...
				  <label class="control-label">Package Image:</label>
					<div class="controls">
						...
						<?php if(!empty($details['image'])) {
							echo '<div><img src="'.BASE_URL.'/uploads/packages/'.$details['image'].'" width="25%"/></div>';
						} ?>
					</div>
				...
				<div class="control-group">
				  <label class="control-label">Banner Image:</label>
					<div class="controls">
						...
						<input type="hidden" name="banner_image_file_name" id="banner_image_file_name" value="<?php echo $details['image'];?>"/>
						<?php if(!empty($details['image'])) {
							echo '<div><img src="'.BASE_URL.'/uploads/packages/'.$details['image'].'" width="25%"/></div>';
						} ?>
					</div>
