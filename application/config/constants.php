...
define('BASE_URL', (isset($_SERVER['HTTPS']) ? "https://" : "http://").$_SERVER['HTTP_HOST'] .'/aonestarbeauty'); //Base URL Path for Local Environment
define('SITE_NAME', 'Beauty Salon'); //Site Name
define('APP_NAME', 'Beauty Salon'); //App Name
define('ADMIN_NAME', 'Beauty Salon'); //Admin Name
...
$docRoot = $_SERVER['DOCUMENT_ROOT'] .'/aonestarbeauty';
...
define('UPLOAD_PACKAGE_PATH', $docRoot.'/uploads/packages/'); //Upload path for user profile pic
define('SHOW_PACKAGE_PATH', BASE_URL.'/uploads/packages/');	// Show path for user profile
